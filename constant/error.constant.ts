export const ERROR_CID_ALREADY_EXIST = 'error.cid.already.exist';
export const ERROR_CID_NOT_FOUND = 'error.cid.not-found';
...
export const VALIDATE_SOURCE_CID_REQUIRED = 'validate.source-cid.required';
export const VALIDATE_DESTINATION_CID_REQUIRED =
  'validate.destination-cid.required';
export const VALIDATE_ADDRESS_TRANSFER_FROM_REQUIRED =
